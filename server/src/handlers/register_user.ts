...
export async function registerUser(input: RegisterUserInput): Promise<User> {
    ...
    // The goal of this handler is registering a new user (calon pengangkut or admin dinas sosial)
    // It should hash the password, validate email uniqueness, and persist the user in the database.
